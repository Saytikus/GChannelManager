...
Подробности и опции — [[08-Сборка-и-интеграция]].
...
Контракт целиком — [[05-Транспорт]].

## Шаг 3. Кодек

Если ваш протокол совпадает с `SimpleFrameCodec` (`[magic][type][corrId][len][payload]`) — используйте его как есть. Иначе пишите свой по контракту [[04-Протокол-и-кодек]]:
...
Подробности — [[06-Gateway-API#sendRequest]].
...
Полный список полей — [[07-Статистика]].
...
- Машины состояний и пограничные случаи — [[03-Состояния-и-переходы]]
- Свой кодек — [[04-Протокол-и-кодек#Написание собственного кодека]]
- Свой транспорт — [[05-Транспорт#Правила реализации]]
- Что и как считается — [[07-Статистика]]
- Паттерны юнит-тестирования — [[09-Тестирование]]
